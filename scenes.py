...
first_scene_objects = [
    scene_object.SceneObject("game_components/assets/download.png", 800, 800, 500, 300, True),
    interactable_objects.InteractableObject("game_components/assets/pixil-frame-0.png", 50, 30, 300, 220, False, interactions = {pg.K_e: "pacman"})
    ]
