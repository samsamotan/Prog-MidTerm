...
class MainMenu(Scene):
    ...
    def start(self):
        ...
        new_game = InteractiveObject(225, 150, 270, 48, self.manager, "Main Scene", os.path.join(assets_folder, "new_game.png"))
        new_game.add_action(pg.K_e, "change scene")
        load_game = InteractiveObject(225, 210, 270, 48, self.manager, "Main Scene", os.path.join(assets_folder, "load_game.png"))
